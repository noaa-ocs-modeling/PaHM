...
!    !----- converted data from the above values (if needed)
  ...
  SUBROUTINE ReadBestTrackFile()
    ...
    fmtStr = '(a2, 2x, i2, 2x, a10, 2x, i2, 2x, a4, 2x, i3, 2x, i3, a1, 2x, i4, a1, 2x, i3, 2x, i4, 2x, a2, '
      fmtStr = TRIM(fmtStr) // ' 2x, i3, 2x, a3, 4(2x, i4), 2x, i4, 2x, i4, 2x, i3, 2x, i4, 2x, i3, '
      fmtStr = TRIM(fmtStr) // ' 2x, a3, 2x, i3, 2x, a3, 1x, i3, 2x, i3, 2x, a11, 2x, i3)'
    !----------
      ...
      DO WHILE (.TRUE.)
        ...
        IF (lenLine /= 0) THEN
          ...
          READ(line, FMT=fmtStr, ERR=11, IOSTAT=ios)                                     &
            ...
            bestTrackData(iFile)%cycleNum(iCnt)
